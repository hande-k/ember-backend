...
const ELEVENLABS_API_KEY = "sk_5ecce66da0fe45f9bbdfa4f3a07d498fcd97e4ed25f64baa";
const VOICES = [
  { id: "21m00Tcm4TlvDq8ikWAM", name: "Rachel" },
  { id: "AZnzlk1XvdvUeBnXmlld", name: "Domi" },
  { id: "EXAVITQu4vr4xnSDxMaL", name: "Bella" },
  // weitere Voices hier hinzufügen
];
    ...
    try {
      const response = await fetch(
        `https://api.elevenlabs.io/v1/text-to-speech/${voice}`,
        {
          ...
          body: JSON.stringify({
            text: book.content.substring(0, 2500), // Limit beachten!
    ...
    <div className="min-h-screen bg-background py-16 px-4 md:px-6 flex flex-col items-center">
      <div className="max-w-3xl w-full space-y-10">
        ...
        <section className="bg-black/90 text-white rounded-xl shadow-lg p-6 md:p-10 space-y-4">
          ...
          <h3 className="text-lg font-sans mb-4">by {book.author}</h3>
