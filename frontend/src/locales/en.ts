export const en = {
  ...
  hero: {
    ...
    description: "Enjoy a good read and meet likeminded people",
    bookStay: "Write your own Story",
    exploreApartments: "Explore Stories",
    scrollDown: "Scroll Down"
  },
  footer: {
    description: "The best stories to read, written by you",
